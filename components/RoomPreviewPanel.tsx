...
const RoomPreviewPanel: React.FC<RoomPreviewPanelProps> = ({
  ...
  <section className={`order-4 rounded-[30px] border p-5 shadow-[0_18px_70px_rgba(88,63,37,0.1)] backdrop-blur-xl lg:order-3 ${
    ...
    <div className={`mt-5 overflow-hidden rounded-[26px] border p-3 ${theme === 'dark' ? 'border-white/10 bg-[linear-gradient(160deg,_rgba(42,37,33,0.95),_rgba(27,24,21,0.92))]' : 'border-stone-900/6 bg-[linear-gradient(160deg,_rgba(243,238,231,0.95),_rgba(232,224,214,0.92))]'}`}>
    ...
    <button
      type="button"
      onClick={onApply}
      className={`mt-5 w-full rounded-[22px] border px-5 py-4 text-sm font-semibold transition ${
        theme === 'dark'
